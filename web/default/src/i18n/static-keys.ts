...
export const STATIC_I18N_KEYS = [
  ...
  'Organization',
  'Organization Owner',
  'Full organization access, including roles, billing, and sensitive data.',
  'Organization Admin',
  'Manage members, departments, API keys, and organization usage without platform-level settings.',
  'Department Lead',
  'Manage and inspect usage for one department.',
  'Developer',
  'Use models, manage own API keys, and inspect own usage.',
  'Operations',
  'Inspect usage trends, model consumption, and export operational reports.',
  'Finance',
  'View balances, orders, billing exports, and spend reports without prompts or secrets.',
  'Support',
  'Troubleshoot member issues with sanitized logs and error details.',
  'Business',
  'View department or customer usage reports without managing keys or settings.',
  'Auditor',
  'Read security audit records and permission changes.',
  'Organization Roles',
  'Workspace',
  'Member Management',
  'Role Permissions',
  ...
  'View overview',
  'View organization dashboards and notices.',
  'View announcements',
  'View organization and platform announcements.',
  'View members',
  'View organization members.',
  'Create members',
  'Create or invite organization members.',
  'Edit members',
  'Edit member profile, department, and status.',
  'Disable members',
  'Disable organization members.',
  'Reset member passwords',
  'Reset member passwords or authentication factors.',
  'View roles',
  'View role templates and grants.',
  'Create roles',
  'Create organization role templates.',
  'Edit roles',
  'Edit organization role templates.',
  'Delete roles',
  'Delete custom role templates.',
  'Assign roles',
  'Assign roles to organization members.',
  'View departments',
  'View departments and department members.',
  'Create departments',
  'Edit departments',
  'Delete departments',
  'View own keys',
  'View API keys owned by the member.',
  'View department keys',
  "View API keys in the member's department.",
  'View organization keys',
  'View API keys across the organization.',
  'Create API keys',
  'Edit API keys',
  'Edit API key limits, models, and status.',
  'Delete API keys',
  'View full API keys',
  'Reveal complete API key secrets.',
  'View models',
  'View available models and prices.',
  'Use models',
  'Call enabled models through organization API keys.',
  'Assign model access',
  'Adjust member or role model access.',
  'View own usage',
  "View the member's own usage.",
  'View department usage',
  'View department usage summaries.',
  'View organization usage',
  'View full organization usage summaries.',
  'Analyze by member',
  'Break usage down by member.',
  'Analyze by department',
  'Break usage down by department.',
  'Analyze by model',
  'Break usage down by model.',
  'Export usage reports',
  'View own logs',
  "View the member's own request logs.",
  'View department logs',
  'View department request logs.',
  'View organization logs',
  'View all organization request logs.',
  'View error reasons',
  'View upstream error and failure details.',
  'View request IDs',
  'View request and upstream request IDs.',
  'View prompts',
  'View prompt content from request logs.',
  'View responses',
  'View response content from request logs.',
  'Export logs',
  'Export request logs.',
  'View balance',
  'View organization balance and quota.',
  'Allocate member quota',
  'Allocate or adjust member quota.',
  'Edit department budgets',
  'Adjust department budgets.',
  'View quota transactions',
  'View quota changes and usage records.',
  'Edit quota alerts',
  'Configure quota warning thresholds.',
  'View billing balance',
  'View balances and recharge records.',
  'View orders',
  'View orders, invoices, and payment records.',
  'View spend details',
  'View organization spend details.',
  'Export billing data',
  'Export billing and invoice data.',
  'Manage payment methods',
  'Lookup members',
  'Search members for support.',
  'View sanitized logs',
  'View sanitized request details.',
  'View support errors',
  'View error details needed for support.',
  'Retry tasks',
  'Retry failed supported tasks.',
  'View login logs',
  'View member login logs.',
  'View operation audits',
  'View operation audit records.',
  'View permission changes',
  'View role and permission changes.',
  'Export audit logs',
  ...
  'Edit organization name and profile.',
  'Edit security settings',
  'Edit organization security settings.',
  'Edit default policies',
  'Edit default role and quota policies.',
